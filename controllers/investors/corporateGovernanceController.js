    ...
    static async getAll(req, res, next) {
        try {
            ...
            if (!page && !limit) {
                ...
                return res.json({ success: true, data: governances });
            }
            ...
            const cacheKey = search ? null : `corporateGovernance_page_${pageNum}_limit_${limitNum}`;

            const { count, rows } = await CorporateGovernance.findAndCountAll({
