...
font-weight: 400;
line-height: 22px;">
A new job posting has been created and requires your approval
...
font-weight: 400;
line-height: 22px;">
Please log in to the admin panel to review the job details
and approve the posting at your earliest convenience.
</p>
<div style="text-align: center; margin: 30px 0;">
<a href="#" style="background-color: #17479E;
color: white;
padding: 12px 30px;
...
<a href="mailto:care@indelmoney.com"
style="display: block;font-family: 'Open Sans', sans-serif; text-decoration: none; font-size: 14px; color: #444444; font-weight: 400; margin: 0px; text-align: right;">
care@indelmoney.com
</a>
</td>
...
font-weight: 400;
line-height: 22px;">
We received a request to reset your password for your Indel Money account.
</p>
<p style="color: #001A32;
font-size: 14px;
text-align: center;
...
module.exports = { sendOtpEmail, newsLetterConfirmation, enquiryMail, careerMail, sendMailToHRs, sendPasswordResetEmail };
